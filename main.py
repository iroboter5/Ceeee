...
bot_token="5937091826:AAH41d4lQNp_y66DkW5sYMiUSrvXlwiJ_yw") #Ingresa el token de tu bot
 
####Configuración de todos los usuarios###$
UserCollection = {'nautaii'}
...
def commands(client, message):
    ...
    if '/start' in text:
        UserCollection[username] = {'user':'---','passw':'---','host':'---','repo':4,'userid':'---','zips':100}
